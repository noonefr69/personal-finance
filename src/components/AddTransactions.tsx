            ...
            <form>
              <div className="flex flex-col space-y-2">
                ...
                <input
                  ...
                  className="border-[1px] rounded-lg p-3 border-gray-600 duration-300 outline-offset-4 outline-transparent focus:outline-black"
                />
              ...
              <button type="submit" className=" mt-8 cursor-pointer w-full flex items-center justify-center gap-3 bg-gray-900 text-white rounded-lg py-3 px-4 text-md font-semibold shadow-sm hover:opacity-80 transition">
                Submit
              </button>
            </form>
          </DialogHeader>
