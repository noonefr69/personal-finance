...
export default async function SignIn() {
  ...
  return (
    <div className="grid grid-cols-12 h-screen">
      <div
        className="col-span-5 m-10 relative rounded-2xl hidden lg:flex"
        id="backgroundLeft"
      >
        <div className="m-10">
          <svg
      ...
      <div className="fixed lg:hidden flex items-center justify-center p-8 rounded-b-lg top-0 left-0 right-0 bg-black">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="122"
          height="22"
      ...
      <div className="lg:col-span-7 col-span-12 flex flex-col justify-center items-center lg:m-10">
        <div className="bg-white w-4/5 h-1/2 rounded-2xl p-10">
          ...
          <div className="space-y-4 h-full flex flex-col pb-14 justify-center">
            ...
            >
              <button
                type="submit"
                className="cursor-pointer w-full flex items-center text-sm lg:text-base justify-center gap-3 bg-gray-800 text-white rounded-lg py-3 px-4 font-medium shadow-sm hover:bg-gray-900 transition"
              >
                <SiGithub />
                Sign in with GitHub
              </button>
